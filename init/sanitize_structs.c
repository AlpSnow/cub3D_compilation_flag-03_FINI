...
static void	init_empty_config(t_player_speed_config *player_speed_config, t_camera_config *camera_config, t_dimensions_config *dimensions_config)
{
...
void	sanitize_structs(t_resources *resources)
{
	...
	init_empty_config(&(resources->player_speed_config), &(resources->camera_config), &(resources->dimensions_config));
}
