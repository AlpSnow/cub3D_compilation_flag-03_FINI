...
/**
 * Rendu complet d'une frame avec raycasting.
 *
 * Pour chaque colonne de l'écran :
 *  1. Initialise un rayon en fonction de la position caméra et de la colonne.
 *  2. Effectue le DDA pour détecter le mur.
 *  3. Choisit la texture appropriée et calcule la coordonnée x dans cette texture.
 *  4. Dessine la colonne correspondante sur l'image.
 */
...
// wall_x = partie décimale du point d’impact (0.0 → 1.0)
