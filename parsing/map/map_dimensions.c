...
static int	get_height_and_width(char **line, int fd, t_map_data *map_data, int i)
{
	int	len;
...
static void	has_map_multiple_blocks(int map_status, char **line, int fd, t_map_data *map_data)
{
    int i;
